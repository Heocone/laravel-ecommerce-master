                        ...
                        <td colspan="2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <input type="radio" name="payment_method" value="MONEY" checked  style="position: relative;">
                                    <img src="{{ asset('images\order-icon-18.jpg') }}" style="width:20%">
                                </div>
                                <div class="col-md-6">
                                    <label for="">Ví VNPAY</label>
                                    <br>
                                    <input type="radio" name="payment_method" value="VNPAY" checked  style="position: relative;">
                                    <img src="{{ asset('images\vnpay-logo-CCF12E3F02-seeklogo.com.png') }}" style="width:50%">
                                </div>
                            </div>
