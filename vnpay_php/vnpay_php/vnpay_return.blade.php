...
<html lang="en">
    ...
    <body>
        ...
        ?>
        <!--Begin display -->
        <form action="{{ url('VNPAYCOMPLETE') }}" method="post">
            <div class="container">
                ...
                <div class="table-responsive">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="KETQUA" value="{{ $ketquathanhtoan }}">
                ...
                <button type="submit">Quay tro lai trang web</button>
                <footer class="footer">
